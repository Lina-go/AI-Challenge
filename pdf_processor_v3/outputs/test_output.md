...
We have and continue to expand and qualify a broad network in Australia to support delivery of Australian Industrial Capability commitments and introduction of Australian suppliers to the Rheinmetall Global Supply Chain. Rheinmetall Group products are dependent on a highly integrated, complex and well-qualified supply base. The Group seeks a high degree of compliance with internationally recognised standards, such as ISO 9001, from its suppliers. Environment, Social Responsibility and Governance criteria form part of the evaluation and selection process when considering new supplier relationships as well as ongoing surveillance.

[FIGURE_1] - NOT_INFORMATIVE figure (not parsed)

## Figure 2

**Photographic Representation of Rheinmetall Defence Australia Event**
- Image showing Rheinmetall Defence Australia Managing Director with RGM and Supacat representatives and Australian Defence Force representatives in Melbourne 2024.
...
|----------|---------|------------|-----------------------------|----------|-------------------------------|
| AA (Scale: CCC-AAA); only 1 out of 34 companies score higher | C (Scale: D- - A+); only 2 out of 72 companies score higher | 34 (Scale 0–100); industry average 29 | 81 | 56.45 | 26.8 |
