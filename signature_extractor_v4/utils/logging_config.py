...
def setup_logging(
    ...
    if log_file:
        ...
        config['loggers']['signature_extractor_v3']['handlers'].append('file')
...
def get_logger(name: str) -> logging.Logger:
    ...
    Returns:
        Logger instance
    """
    return logging.getLogger(f"signature_extractor_v3.{name}")
...
def set_log_level(level: str):
    ...
    """
    logger = logging.getLogger('signature_extractor_v3')
